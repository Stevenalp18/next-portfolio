    ...
    return(
        <section className="bg-[url('/starry-night.jpg')] w-screen bg-no-repeat bg-center bg-cover w-screen h-auto bg-top p-12 sm:p-14">
            ...
            <div className="flex flex-col gap-10 sm:flex-row sm:gapx-4 mx-auto max-w-screen-lg">
                ...
                />
                <div className="">
                    <p className="text-white font-sono text-center text-lg sm:text-left sm:text-2xl" id="about-me">Hi, I am Steven Perez. I am the proud owner, designer, web developer of this website and the projects below.
